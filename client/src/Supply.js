...
function Supply() {
    ...
    return (
        <div className='container'>
            ...
            <h5><b>Step 1: Supply Raw Materials</b></h5>
            <form onSubmit={handlerSubmitRMSsupply}>
                ...
                <button className="btn btn-outline-success btn-sm btn-order" onSubmit={handlerSubmitRMSsupply}>Supply</button>
            </form>
            <hr />
            <br />
            <h5><b>Step 2: Manufacture</b></h5>
            <form onSubmit={handlerSubmitManufacturing}>
                <input className="form-control-sm" type="text" onChange={handlerChangeID} placeholder="Enter Product ID" required />
                <button className="btn btn-outline-success btn-sm btn-order" onSubmit={handlerSubmitManufacturing}>Manufacture</button>
            </form>
            <hr />
            <br />
            <h5><b>Step 3: Distribute</b></h5>
            <form onSubmit={handlerSubmitDistribute}>
                <input className="form-control-sm" type="text" onChange={handlerChangeID} placeholder="Enter Product ID" required />
                <button className="btn btn-outline-success btn-sm btn-order" onSubmit={handlerSubmitDistribute}>Distribute</button>
            </form>
            <hr />
            <br />
            <h5><b>Step 4: Retail</b></h5>
            <form onSubmit={handlerSubmitRetail}>
                <input className="form-control-sm" type="text" onChange={handlerChangeID} placeholder="Enter Product ID" required />
                <button className="btn btn-outline-success btn-sm btn-order" onSubmit={handlerSubmitRetail}>Retail</button>
            </form>
            <hr />
            <br />
            <h5><b>Step 5: Mark as sold</b></h5>
            <form onSubmit={handlerSubmitSold}>
                <input className="form-control-sm" type="text" onChange={handlerChangeID} placeholder="Enter Product ID" required />
                <button className="btn btn-outline-success btn-sm btn-order" onSubmit={handlerSubmitSold}>Sold</button>
            </form>
            <hr />
        </div>
    )
