...
function Home() {
    ...
    return (
        <div style={styles.container}>
            <h1 style={styles.title}><b>SHIPMENTS TRACKING SYSTEM</b></h1>
            <div style={styles.buttons}>
                <div style={styles.buttonContainer}>
                    <h3>Assign Roles</h3>
                    <p>Register raw material suppliers, manufacturers, distributors, and retailers.</p>
                    <button onClick={() => redirectTo('/roles')} style={styles.button}>Register</button>
                </div>
                <div style={styles.buttonContainer}>
                    <h3>Order Products</h3>
                    <p>Order Products from suppliers.</p>
